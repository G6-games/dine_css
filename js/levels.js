var levels = [
  ...
  },
  {
    ...
    <apple for="Abdul"/>
    <plate for="Emma"><pickle/></plate>
    <bento for="Baffah"><orange/></bento>
    <pickle/>`
  },
  {
    selectorName: "Attribute Selector",
    ...
    boardMarkup:`
    <plate for="Azeez"><pickle/></plate>
    <plate for="Jude"><apple/></plate>
    <plate/>
    <bento for="Kola"><orange/></bento>
    `
  },
  {
    selectorName: "Attribute Value Selector",
    helpTitle: "Select all elements that have a specific attribute value",
    doThis : "Select Abdul's meal",
    selector : "[for=Abdul]",
    ...
    boardMarkup:`
    <apple for="Peter" />
    <bento for="Aluka"><apple /></bento>
    <bento for="Abdul"><orange/></bento>
    <pickle/>
    `
  },
  {
    ...
    doThis : "Select the items for names that start with 'Ha'",
    selector : '[for^="Ha"]',
    syntax: '[attribute^="value"]',
    ...
    boardMarkup: `
    <plate for="Nelson"><pickle/></plate>
    <bento for="Micheal"><apple class="small"/></bento>
    <bento for="Halilu"><orange/></bento>
    `
  },
  {
    ...
    doThis : "Select the items for names that end with 'ita'",
    selector : '[for$="ita"]',
    syntax: '[attribute$="value"]',
    help : '',
    examples : [
    ...
    boardMarkup:`
    <apple class="small"/>
    <bento for="Soludo"><pickle/></bento>
    <apple for="Amaka"></apple>
    <plate for="Wanita"><orange/></plate>
    <pickle class="small"/>
    `
  },
  {
    ...
    syntax: '[attribute*="value"]',
    doThis : "Select the meals for names that contain 'iza'",
    selector : '[for*="iza"]',
    ...
    boardMarkup:`
    <bento for="Kabir"><apple /></bento>
    <bento for="Hadiza"><pickle /></bento>
    <bento for="Sherif"><orange /></bento>
    `
  }
];
