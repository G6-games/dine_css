...
$(document).ready(function(){
  ...
  $(".share-menu").on("click","a",function(){
    ...
    if(type == "twitter"){
      var url = "https://twitter.com/intent/tweet?text=Learning%20CSS?%20Try%Dine%20CSS,%20the%20fun%20way%20to%20practice%20selectors%20%E2%86%92&hashtags=css,dinecss,webdev&url=http%3A%2F%2Fg6-games.github.io%2F&via=geekazeezsherif";
    } else if (type == "facebook") {
      var url = "https://www.facebook.com/sharer.php?src=sp&u=http%3A%2F%g6-games.github.io";
    } else if (type == "email") {
      var url = "mailto:?subject=Check+out+Dine+CSS&body=It's+a+fun+game+to+learn+%26+practice+CSS+selectors.%0D%0A%0D%0AYou+can+try+it+at+http://g6-games.github.io";
    }
...
function winGame(){
  $(".table").html('<span class="winner"><strong>You did it!</strong><br>You 🚀️ at CSS.</span>');
  addNametags();
  finished = true;
  resetTable();
}
